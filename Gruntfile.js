module.exports = function(grunt) {
        ...
        processhtml: {
            dist: {
                files: {
                    ...
                    'public/templates/layout_login.html': ['public/templates/layout_login.html'],
                }
            }
        },
        babel: {
    ...
    grunt.registerTask('build', ['clean:all', 'concat:libs', 'concat:app', 'babel', 'uglify', 'cssmin', 'clean:temp', 'processhtml:dist', 'htmlmin']);
};
